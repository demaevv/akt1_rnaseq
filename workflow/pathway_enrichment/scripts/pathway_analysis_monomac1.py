#!/usr/bin/env python3
"""
Pathway/Enrichment Analysis for Mono-Mac-1: PU-001 vs Control
...
# CONFIGURATION
# ============================================================
INPUT_TSV = 'DE_Mono-Mac-1_PU001_vs_CTRL.tsv'
OUTDIR = 'pathway_analysis_MonoMac1'
PADJ_CUTOFF = 0.05
LFC_CUTOFF = 1.0
TOP_N = 200
...
## Mono-Mac-1 Cell Line: PU-001 (200 μM, 24h) vs Control
...
*Generated by pathway_analysis_monomac1.py*
