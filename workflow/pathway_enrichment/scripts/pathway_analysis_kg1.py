#!/usr/bin/env python3
"""
Pathway/Enrichment Analysis for KG-1: PU-001 vs Control
...
# CONFIGURATION
# ============================================================
INPUT_TSV = 'DE_KG-1_PU001_vs_CTRL.tsv'
OUTDIR = 'pathway_analysis_KG1'
PADJ_CUTOFF = 0.05
LFC_CUTOFF = 1.0
TOP_N = 200
...
## KG-1 Cell Line: PU-001 (200 μM, 24h) vs Control
...
*Generated by pathway_analysis_kg1.py*
